...
class _MyAppState extends State<MyApp> {
  ...
  Widget _buildAccountActivation() {
    ...
    //           children: [
    //             Checkbox(
    //               value: true, // Replace with actual agreement state
    //               onChanged: (value) {},
    //             ),
    //             const Text('I agree to the terms & conditions'),
    //           ],
  ...
  Widget _buildOtpConfirmation() {
    ...
    //         TextButton(
    //           onPressed: () {},
    //           child: const Text("Didn't receive? Tap here"),
    //         ),
    //         const SizedBox(height: 10),
    //         ElevatedButton(
    //           onPressed: () {},
  ...
  Widget _buildFooter() {
    ...
    //       TextButton(
    //         onPressed: () {},
    //         child: const Text('Disclaimer | Privacy Statement'),
    //       ),
    //       const Text('Copyright UPM & Kejuruteran Minyak Sawit'),
